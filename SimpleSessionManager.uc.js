...
(function () {
    ...
    function getTime() {
        ...
        var t = d.getFullYear() + "-" + addzero(d.getMonth() + 1) + "-" + addzero(d.getDay()) + "-" + addzero(d.getHours()) + ":" + addzero(d.getMinutes());
        return t;
    }
    ...
    function restoreSessionSelectively() {
        ...
        newTabBrowser.addEventListener("load", function () {
            ...
            cDoc.getElementById("errorLongDesc").innerHTML = "You are about to restore " + name + ", you can uncheck windows or tabs to exclude them from restoration.";
